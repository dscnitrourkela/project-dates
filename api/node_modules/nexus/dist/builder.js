...
class SchemaBuilder {
    constructor(config) {
        ...
        this.plugins = this.config.plugins.length > 0 ? this.config.plugins : [(0, fieldAuthorizePlugin_1.fieldAuthorizePlugin)()];
        if (!this.plugins.find((f) => f.config.name === 'declarativeWrapping')) {
            this.plugins.push((0, plugins_1.declarativeWrappingPlugin)({ disable: true }));
        }
    ...
    addTypes(types) {
        ...
        if ((0, wrapping_1.isNexusNamedTypeDef)(types) ||
            (0, wrapping_1.isNexusExtendTypeDef)(types) ||
            (0, wrapping_1.isNexusExtendInputTypeDef)(types) ||
            (0, graphql_1.isNamedType)(types) ||
            (0, wrapping_1.isNexusDynamicInputMethod)(types) ||
            (0, wrapping_1.isNexusDynamicOutputMethod)(types) ||
            (0, wrapping_1.isNexusDynamicOutputProperty)(types) ||
            (0, nexusMeta_1.isNexusMeta)(types)) {
            this.addType(types);
        }
        ...
        interfaces.forEach((i) => {
            ...
            Object.keys(config.fields).forEach((field) => {
                ...
                if (modifications[field]) {
                    ...
                    const _f = modifications[field], { type, field: _field, args, extensions } = _f, rest = (0, tslib_1.__rest)(_f, ["type", "field", "args", "extensions"]);
                    const extensionConfig = (0, extensions_1.hasNexusExtension)(extensions === null || extensions === void 0 ? void 0 : extensions.nexus)
                        ? (_b = (_a = extensions === null || extensions === void 0 ? void 0 : extensions.nexus) === null || _a === void 0 ? void 0 : _a.config) !== null && _b !== void 0 ? _b : {}
                        : {};
                    interfaceFieldsMap[field] = Object.assign(Object.assign(Object.assign({}, interfaceFieldsMap[field]), rest), { extensions: Object.assign(Object.assign(Object.assign({}, interfaceField.extensions), extensions), { nexus: (0, extensions_1.hasNexusExtension)((_c = interfaceField.extensions) === null || _c === void 0 ? void 0 : _c.nexus)
    ...
    buildArgs(args, typeConfig, fieldName) {
        ...
        for (const [argName, arg] of Object.entries(args)) {
            const nonNullDefault = this.getNonNullDefault((_b = (_a = typeConfig.extensions) === null || _a === void 0 ? void 0 : _a.nexus) === null || _b === void 0 ? void 0 : _b.config, 'input');
            let finalArgDef = Object.assign(Object.assign({}, (0, wrapping_1.normalizeArgWrapping)(arg).value), { fieldName,
...
function setConfigDefaults(config) {
    ...
    const defaults = {
        ...
        plugins: [(0, fieldAuthorizePlugin_1.fieldAuthorizePlugin)()],
    };
    if (!config.features) {
